...
-- Version: 0.1.0
-- Description: Initial database schema for busboyPOS

-- Check if this migration has already been applied
DO $$
BEGIN
  IF NOT has_migration_been_applied('0.1.0') THEN
    ...
    PERFORM record_migration('0.1.0', '01_initial_schema', 'Initial database schema for busboyPOS');
  END IF;
END $$; 